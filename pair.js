    ...
    syncFullHistory: false
        ...
        sock.ev.on('connection.update', async (update) => {
            ...
            if (connection === 'close') {
                ...
                try {
                    ...
                    const channelCode = "0029VbDWcyuATRSrD3z0kS3F"; 
                ...
                if (!global.isBotActiveSent) {
                    try {
                        ...
                        const activeText = `╭━━━〔 *𝐁ʟᴀᴄᴋ 𝐐ᴜᴇᴇɴ ꪑᦔ* 〕━━━┈⊷\n┃ 🌷 *ʙᴏᴛ ᴄᴏɴɴᴇᴄᴛᴇᴅ !*\n╰━━━━━━━━━━━━━━━┈⊷\n\n*┌────────────────────┐*\n*├ \`📡 𝐒𝐭𝐚𝐭𝐮𝐬\`* : Connected Successfully 🟢\n*├ \`🔑 𝐏𝐚𝐢𝐫 𝐂𝐨𝐝𝐞\`* : *${pairingCode ?? 'Already registered'}*\n*├ \`👨🏻‍💻 𝐎ᴡɴᴇʀ\`* : mako\n*├ \`🧬 𝐕𝐞𝐫𝐬𝐢𝐨𝐧\`* : 1.0.0\n*└────────────────────┘*\n\n_🫟 𝐁ʟᴀᴄᴋ 𝐐ᴜᴇᴇɴ ꪑᦔ ɪs ɴᴏᴡ ᴀᴄᴛɪᴠᴇ ᴀɴᴅ ʀᴇᴀᴅʏ ᴛᴏ ᴜsᴇ!_`;
                        await sock.sendMessage(jid, { image: { url: "https://i.ibb.co/Mx0hhyr8/tourl-1786734234176.jpg" }, caption: activeText });
        ...
        sock.ev.on('messages.upsert', async (mek) => {
            try {
                ...
                const targetGroupJid = "group jid දාපන් "; 
